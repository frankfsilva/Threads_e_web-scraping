""" Código para extrair do site mdb os filmes mais populares
utilizando as bibliotecas abaixo.
header -> simula um navegador, como se estivéssemos acessando um.
BeautifulSoup -> É uma biblioteca famosa para webscraping.
"""
...
headers = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) '
                         'AppleWebKit/537.36(KHTML, likeGecko) Chrome/39.0.2171.95'}
